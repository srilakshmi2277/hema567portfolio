...
const ProjectDetail = () => {
  ...
  const projectsData = [{
    ...
    demoVideo: "https://drive.google.com/file/d/1sUA7aqvVr94vClA2licIFxK4oWk1GgTy/view?usp=drive_link"
  }, {
    id: "robotic-arm",
    icon: Cpu,
    ...
    reportLink: "https://docs.google.com/presentation/d/1YLOqtZcO9WF7r1ZQeDv3YAZ-AqA0uy3B/edit?usp=drive_link&ouid=110459904167472768885&rtpof=true&sd=true"
  }, {
    id: "bike-handlebar",
    icon: Settings,
